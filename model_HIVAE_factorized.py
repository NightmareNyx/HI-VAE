...
def encoder(X_list, miss_list, batch_size, z_dim, s_dim, tau):
    ...
    samples['z'], q_params['z'] = VAE_functions.z_proposal_GMM_factorized(X_list, samples['s'], miss_list, batch_size,
                                                                          z_dim, reuse=None)
...
def samples_generator(batch_data_list, X_list, miss_list, types_list, batch_size, z_dim, y_dim, y_dim_partition, s_dim,
    ...
    # Create the proposal of q(z|s,x^o)
    _, params = VAE_functions.z_proposal_GMM_factorized(X_list, samples_test['s'], miss_list, batch_size, z_dim,
                                                        reuse=True)
